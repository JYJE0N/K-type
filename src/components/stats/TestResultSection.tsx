...
export function TestResultSection({ 
  ...
  // 신기록 여부 확인
  const currentScore = primaryMetric === 'cpm' ? (liveStats.cpm || 0) : (liveStats.wpm || 0);
    ...
    <div className={className}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
        ...
        <div className="flex flex-col items-center p-4 rounded-xl text-center" 
          ...
          <FaKeyboard className="w-6 h-6 mb-2" style={{ color: themeColors.primary, opacity: 0.8 }} />
        ...
        <div className="flex flex-col items-center p-4 rounded-xl text-center" 
          ...
          <Target className="w-6 h-6 mb-2" style={{ color: themeColors.primary, opacity: 0.8 }} />
          <div className="text-2xl font-bold mb-1" style={{ color: themeColors.primary }}>
            {(liveStats.accuracy || 0).toFixed(1)}<span className="text-sm">%</span>
          </div>
          <div className="text-sm font-medium" style={{ color: themeColors.muted }}>
            정확도
          </div>
        ...
        <div className="flex flex-col items-center p-4 rounded-xl text-center" 
          ...
          <AiFillThunderbolt className="w-6 h-6 mb-2" style={{ color: themeColors.primary, opacity: 0.8 }} />
          <div className="text-2xl font-bold mb-1" style={{ color: themeColors.primary }}>
        ...
        <div className="flex flex-col items-center p-4 rounded-xl text-center" 
          ...
          <IoTime className="w-6 h-6 mb-2" style={{ color: themeColors.primary, opacity: 0.8 }} />
          <div className="text-2xl font-bold mb-1" style={{ color: themeColors.primary }}>
            {Math.floor((liveStats.timeElapsed || 0) / 60)}:{String(Math.floor((liveStats.timeElapsed || 0) % 60)).padStart(2, '0')}
          </div>
          <div className="text-sm font-medium" style={{ color: themeColors.muted }}>
            소요시간
          </div>
        ...
        <div className="flex flex-col items-center p-4 rounded-xl text-center" 
          ...
          <IoTrophy className="w-6 h-6 mb-2" style={{ color: themeColors.primary, opacity: 0.8 }} />
          <div className="text-2xl font-bold mb-1" style={{ color: themeColors.secondary }}>
        ...
        <div className="flex flex-col items-center p-4 rounded-xl text-center" 
          ...
          <IoSparkles className="w-6 h-6 mb-2" style={{ color: themeColors.primary, opacity: 0.8 }} />
          <div className="text-2xl font-bold mb-1" style={{ color: themeColors.primary }}>
            {isNewRecord ? '신기록!' : '완료'}
          </div>
          <div className="text-sm font-medium" style={{ color: themeColors.muted }}>
