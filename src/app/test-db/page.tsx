...
export default function TestDBPage() {
  ...
  const testConnection = async () => {
    ...
    try {
      const response = await axios.get("/api/db-connection-test");
                  ...
                  <>
                    <div className="flex">
                      ...
                      <span className="text-text-primary">
                        {results.results.database.host}
                      </span>
                    </div>
                    <div className="flex">
                      <span className="text-text-secondary w-32">포트:</span>
                      <span className="text-text-primary">
                        {results.results.database.port}
                      </span>
                    </div>
                    <div className="flex">
            ...
            {results.results.collections && (
              <div className="bg-surface rounded-lg p-6">
                ...
                <div className="mt-4 pt-4 border-t border-text-secondary border-opacity-20">
                  <p className="text-text-secondary text-sm">
                    UserProgress 컬렉션:{" "}
                    {results.results.userProgressCollection}
                  </p>
                </div>
              </div>
            )}
